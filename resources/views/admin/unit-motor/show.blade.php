...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div class="btn-group">
            <a href="{{ route('admin.unit-motor.edit', $unitMotor) }}" class="btn btn-warning">
                <i class="bi bi-pencil me-2"></i> Edit
            </a>
            <form action="{{ route('admin.unit-motor.destroy', $unitMotor) }}" method="POST" class="d-inline">
                @csrf
                @method('DELETE')
            ...
            <div class="col-md-8">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <p class="mb-0">{{ $unitMotor->created_at->format('d M Y H:i') }}</p>
                    </div>
                    
                    <div class="col-md-6 mb-3">
                        <strong>Last Updated:</strong>
                        <p class="mb-0">{{ $unitMotor->updated_at->format('d M Y H:i') }}</p>
                    </div>
                </div>
            </div>
        </div>
